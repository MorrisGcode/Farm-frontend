    ...
    return (
        <div className="min-h-screen bg-gray-50 p-4 sm:p-6 md:p-8 font-inter">
            <div className="max-w-6xl mx-auto bg-white rounded-xl shadow-lg p-6 sm:p-8">
                ...
                {/* Daily Feeding Log Form - Only visible to Workers */}
                {user.role === 'WORKER' && (
                    <DailyFeedingLogForm
                        feedTypes={feedTypes}
        ...
        <form onSubmit={handleSubmit} className="p-6 border border-gray-200 rounded-lg shadow-sm bg-gray-50">
            ...
            <div className="mt-6 border p-4 rounded-md bg-white">
                ...
                <button
                    ...
                    className="mt-4 px-4 py-2 border border-blue-300 rounded-md shadow-sm text-sm font-medium text-blue-700 bg-blue-50 hover:bg-blue-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out flex items-center"
                >
